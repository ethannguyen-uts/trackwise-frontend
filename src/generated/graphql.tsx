...
export type ProductFragmentFragment = { __typename?: 'Product', id: string, name: string, imageUrl: string, scrapePrice: number, currentPrice: number, targetPrice: number, status: string, userId: string };
...
export type AddProductMutation = { __typename?: 'Mutation', addProduct: { __typename?: 'Product', id: string, name: string, imageUrl: string, scrapePrice: number, currentPrice: number, targetPrice: number, status: string, userId: string } };
...
export type ProductsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, name: string, imageUrl: string, scrapePrice: number, currentPrice: number, targetPrice: number, status: string, userId: string }> };
